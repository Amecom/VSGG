...
/**
    ...
    THIS CONTRACT SHOWS AN EXAMPLE OF GENETIC RECOMBINATION WITH RANDOMLY SELECTED VALUES WITHIN THE PERMITTED RANGES.
    ...
    * Generating a Viable Seed:
        ...
        - A Viable Seed can only be created through the genetic recombination of two Vibrant Seeds.
    ...
    * Mutating a Viable Seed: 
    ...
    Additionally, the newly generated or mutated genetic code must be unique, meaning it cannot 
